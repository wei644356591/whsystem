<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:60:"F:\whsystem\public/../application/index\view\safe\index.html";i:1508378075;s:60:"F:\whsystem\public/../application/index\view\tpl\header.html";i:1508035573;s:60:"F:\whsystem\public/../application/index\view\tpl\footer.html";i:1508135442;s:57:"F:\whsystem\public/../application/index\view\tpl\msg.html";i:1506260401;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
        ...
        <div class="assets_content  bg_w" id="safebox" style="margin: 0 auto;"><h1>
                ...
                <div style="float:left; margin-left:20px;">
                    <div class="sc_level">
                        <div class="sc_level_4">
                            <img id="member_logo_change" style="width:102px; height:102px;cursor:pointer;" src="<?php echo $logo; ?>">
                        </div>
                        <form action="<?php echo url('member/change_logo'); ?>" id="member_logo_form" method="post" enctype="multipart/form-data">
                            <input type="file" name="logo" id="member_logo_input" style="display: none;">
                        </form>
                        <!--<div class="sc_level_info"></div>-->
                    </div>
                    <dl>
                        <dt>ID：<span><?php if(!empty($online_user['uid'])) echo $online_user['uid']; ?></span></dt>
                        <dd>姓名：<?php echo (isset($auth['real_name'] ) && ($auth['real_name']  !== '')?$auth['real_name'] :'未认证'); ?></dd>
                        <dd>电话：<?php if(!empty($online_user['name'])) echo $online_user['name']; ?></dd>
                    </dl>
                </div>
                <div style="float:left; margin-left:170px;">
                    <dl style=" padding-top:0px !important;"><span style="font-size:16px;">人民币信息</span>
                        <dt>可用：￥<?php echo (isset($online_user['can'] ) && ($online_user['can']  !== '')?$online_user['can'] :0.0000); ?></span></dt>
                        <dd>冻结：￥<?php echo (isset($online_user['block'] ) && ($online_user['block']  !== '')?$online_user['block'] :0.0000); ?></dd>
                        <dd>总资产：￥<?php echo $online_user['can'] + $online_user['block']; ?></dd>
                    </dl>
                </div>
            </div>
            <ul class="sc_statu">
                <li>
                    <?php if($auth['status'] != 2): ?>
                    <em class="sc_statu_type_1_1"></em>
                    <dl>
                        <dt>实名认证</dt>
                        <dd class="nopass"><?php echo $auth_status_str; ?><a href="<?php echo url('safe/auth'); ?>" id="check_member_auth" auth_status="<?php if(!empty($auth['status'])) echo $auth['status']; ?>">点击认证</a></dd>
                    </dl>
                    <?php else: ?>
                    <em class="sc_statu_type_1"></em>
                    <dl>
                        <dt>实名认证</dt>
                        <dd class="alpass">已认证<a href="<?php echo url('safe/ytg_auth'); ?>">查看</a></dd>
                    </dl>
                    <?php endif; ?>
                </li>
                <!--<li>
                    <if condition="$u_info['phone']">
                        ...
                        <dl>
                            <dt>绑定手机</dt>
                            <dd class="alpass">已认证 <a href="<?php echo url('User/updateMassage'); ?>">查看</a></dd>
                        </dl>
                        <else/>
                        <em class="sc_statu_type_3_1"></em>
                        <dl>
                            <dt>绑定手机</dt>
                            <dd class="nopass">未认证 <a href="<?php echo url('ModifyMember/modify'); ?>">点击绑定</a></dd>
                        </dl>
                    </if>
                ...
                <li>
                    ...
                    <dl>
                        <dt>账户资产</dt>
                        <dd class="alpass">已认证<a href="<?php echo url('safe/center'); ?>">点击进入</a></dd>
                    </dl>
                </li>
            </ul>
            <div class="sc_info_list" id="sc_info_list">
                <dl style="background-color: rgb(249, 249, 249);">
                    <dt>登录密码</dt>
                    <dd><p>登录<?php echo $config['title']; ?>账户时需要输入的密码</p></dd>
                    <dd>
                        <div class="changepw"><a href="<?php echo url('safe/update_pass',['active'=>1]); ?>">修改登录密码</a></div>
                    </dd>
                </dl>
                <dl style="background-color: rgb(255, 255, 255);">
                    <dt>交易密码</dt>
                    <dd><p>在<?php echo $config['title']; ?>进行交易时需要输入的密码</p></dd>
                    <dd>
                        <div class="changepw"><a href="<?php echo url('safe/update_pass',['active'=>2]); ?>">修改交易密码</a></div>
                    </dd>
                </dl>
                <!--<dl style="background-color: rgb(255, 255, 255);">
                    <dt>手机绑定</dt>
                    <if condition="$u_info['phone']">
                        ...
                        <dd>
                            <div class="changepw">
                                <a href="<?php echo url('User/updateMassage'); ?>">查看</a>
                            </div>
                        </dd>
                        <else/>
                        <dd>
                        ...
                        <dd>
                            <div class="changepw">
                                <a href="<?php echo url('ModifyMember/modify'); ?>">绑定</a>
                            </div>
                        </dd>
                    </if>
                </dl>-->
