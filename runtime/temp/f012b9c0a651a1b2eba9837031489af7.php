<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"G:\whsystem\public/../application/admin\view\fund\consume.html";i:1507000494;s:58:"G:\whsystem\public/../application/admin\view\tpl\head.html";i:1507171628;s:57:"G:\whsystem\public/../application/admin\view\tpl\msg.html";i:1506260401;}*/ ?>
...
<div class="div_from_aoto" style="margin: 0 auto;width: 500px;">
    <form action="<?php echo url('fund/consume'); ?>" method="post" id="user_add_form">
        <div class="control-group">
            <label class="laber_from">提现最低额度(选填，填0表示不限制最低额度):</label>
            <div class="form-group">
                <input class="form-control" name="zd_money" type=text placeholder="提现最低额度" v-data="number">
                <P class=help-block></P></div>
        </div>
        <div class="control-group">
            <label class="laber_from">提现最高额度(选填，填0表示不限制最高额度):</label>
            <div class="form-group">
