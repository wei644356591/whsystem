<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:66:"F:\whsystem\public/../application/index\view\safe\update_pass.html";i:1508382402;s:60:"F:\whsystem\public/../application/index\view\tpl\header.html";i:1508035573;s:60:"F:\whsystem\public/../application/index\view\tpl\footer.html";i:1508135442;s:57:"F:\whsystem\public/../application/index\view\tpl\msg.html";i:1506260401;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
            ...
            <div class="support_ybc pass_ybc">
                ...
                <div id="tagContent" class="passContent">
                    <div class="tagContent selectTag" id="tagContent0" style="display: none;">
                        <form method="post" id="signupForm" action="<?php echo url('safe/do_update_pass'); ?>" id="update_login_pass_form">
                    ...
                    <div class="tagContent" id="tagContent1" style="display: block;">
                        ...
                        <form method="post" id="PwdtradeForm" action="<?php echo url('safe/do_update_paypass'); ?>">
                            <ul class="ybc_con" style=" margin-left:150px;">
                                <li>
