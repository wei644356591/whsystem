<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:58:"F:\whsystem\public/../application/admin\view\user\add.html";i:1506439888;s:58:"F:\whsystem\public/../application/admin\view\tpl\head.html";i:1507301026;s:57:"F:\whsystem\public/../application/admin\view\tpl\msg.html";i:1506260401;}*/ ?>
...
<div class="div_from_aoto" style="margin: 0 auto;width: 500px;">
    <form action="<?php echo url('user/add'); ?>" method="post" id="user_add_form">
        <div class="control-group">
            <label class="laber_from">您的用户名(必填):</label>
            <div class="form-group">
                <input class="form-control" name="name" type=text placeholder="请输入用户名" v-min="3" v-max="16">
                <P class=help-block></P></div>
        </div>
        <div class="control-group">
            <label class="laber_from">您的密码(必填):</label>
            <div class="form-group">
                <input class="form-control" name="password" type=text placeholder="请输入密码" v-min="3" v-max="16">
                <P class=help-block></P></div>
        </div>
        <div class="control-group">
            <label class="laber_from">确认密码(必填):</label>
            <div class="form-group">
