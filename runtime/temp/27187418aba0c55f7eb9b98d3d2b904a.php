<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"G:\whsystem\public/../application/admin\view\jymanage\jyjl.html";i:1507018308;s:58:"G:\whsystem\public/../application/admin\view\tpl\head.html";i:1507171628;s:57:"G:\whsystem\public/../application/admin\view\tpl\msg.html";i:1506260401;}*/ ?>
...
<table class="table table-hover">
    ...
    <tr>
        ...
        <td>
            <?php echo date("Y-m-d H:i:s",$row['tx_time']); ?>
        </td>
        <td>
...
<script type="text/javascript">
    ...
    $('#look_dcz').click(function () {
        window.location.href = "<?php echo url('jymanage/jy_action',['status'=>1]); ?>";
    });
    $('#look_dtx').click(function () {
        window.location.href = "<?php echo url('jymanage/jy_action',['status'=>2]); ?>";
    });
</script>