<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:60:"F:\whsystem\public/../application/admin\view\tools\menu.html";i:1507022208;s:58:"F:\whsystem\public/../application/admin\view\tpl\head.html";i:1507301026;s:57:"F:\whsystem\public/../application/admin\view\tpl\msg.html";i:1506260401;}*/ ?>
...
<div class="div_from_aoto" style="margin: 0 auto;width: 500px;">
    <form action="<?php echo url('tools/set_menu'); ?>" method="post" id="user_add_form">
        <div class="control-group">
            <label class="laber_from">菜单名称(必填):</label>
            <div class="form-group">
                <input class="form-control" name="name" type=text placeholder="请输入名称" v-min="2" v-max="8">
                <P class=help-block></P></div>
        </div>
        <div class="control-group">
            <label class="laber_from">排序位置(必填):</label>
            <div class="form-group">
                <input class="form-control" name="order" type=text placeholder="请输入排序位置" v-min="2" v-max="8">
                <P class=help-block></P></div>
        </div>
    ...
    <table class="table table-hover">
        ...
        <tr>
            ...
            <td>
                <a href="<?php echo url('tools/menu_del',['id'=>$row['id']]); ?>" onclick="if (!window.confirm('删除后不能找回')) return false" type="button" class="glyphicon glyphicon-trash"></a>
            </td>
        </tr>
        <?php endforeach; ?>
    </table>
