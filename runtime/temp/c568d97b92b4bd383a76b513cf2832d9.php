<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:62:"F:\whsystem\public/../application/index\view\member\login.html";i:1507691367;s:60:"F:\whsystem\public/../application/index\view\tpl\header.html";i:1508035573;s:57:"F:\whsystem\public/../application/index\view\tpl\msg.html";i:1506260401;s:60:"F:\whsystem\public/../application/index\view\tpl\footer.html";i:1508135442;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<div id="main">
    <div class="login_tongyi">
        ...
        <!--<form id="form" method="post" action="<?php echo url('Login/checkLog'); ?>" >  -->
        <form class="form-horizontal m-t" id="signupForm" method="post"  action="<?php echo url('member/login'); ?>">
            <ul class="login">
                <li><label for="email" class="youxiang">手机号：</label>
                    <input name="name" id="email" class="" i="" type="text" v-data="phone"><!-- autocomplete="off"/>-->
                </li>
                <li><label for="pwd" class="youxiang">密码：</label>
                    <input name="pass" id="pwd" class="" i="" type="password" v-data="require"><!-- autocomplete="off"/>-->
                </li>
                <li><label for="pwd" class="youxiang">验证码：</label>
                    <input name="captcha" id="captcha" class="" i="" type="text" v-data="require"><!-- autocomplete="off"/>-->
		...
		<span class="note" id="birthmsg" style="color:red; margin:0;">
                ...
                <li style="margin-bottom:15px;"><label class="youxiang">&nbsp;</label><input class="denglu" id="member_login_btn" value="登录" style="border:0;" type="button"></li>
                <li class="forget" style="margin-bottom:0px;">
                    <label class="youxiang">&nbsp;</label>
                    <a href="<?php echo url('member/find_pass'); ?>">忘记密码？</a>
                    <span style="margin-left:118px;">没有<?php echo (isset($config['title']) && ($config['title'] !== '')?$config['title']:"外汇网"); ?>账号？<a href="<?php echo url('member/register'); ?>" class="zhuce">注册一个</a></span>
                </li>
